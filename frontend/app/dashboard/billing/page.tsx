...
const plans = [
  { name: 'Free', price: '$0/mo', features: ['100 concurrent users', '5 channels', '60s heartbeat', 'Community support'] },
  { name: 'Pro', price: '$39/mo', features: ['10K concurrent users', 'Unlimited channels', '5s heartbeat', 'Webhooks', 'Priority support'] },
  { name: 'Enterprise', price: 'Custom', features: ['Unlimited concurrent', 'Global distribution', 'Sub-second updates', 'SLA guarantee', 'Dedicated support'] },
];
